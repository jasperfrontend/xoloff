...
<template>
  <Form
    ...
    :transform="
      (data) => ({
        ...data,
        salutation: data.salutation === NO_SALUTATION ? null : data.salutation,
      })
    "
  ...
  >
    ...
    <div class="grid gap-4 sm:grid-cols-[10rem_1fr_1fr]">
      <div class="grid gap-2">
        ...
        <Select name="salutation" :default-value="customer?.salutation ?? NO_SALUTATION">
          <SelectTrigger id="salutation" class="cursor-pointer">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
            <SelectItem :value="NO_SALUTATION" class="cursor-pointer"> None </SelectItem>
            <SelectItem
      ...
      <div class="grid gap-2">
        ...
        <Input id="first_name" name="first_name" :default-value="customer?.first_name" required />
        <InputError :message="errors.first_name" />
      </div>

      <div class="grid gap-2">
        <Label for="last_name">Last name</Label>
        <Input id="last_name" name="last_name" :default-value="customer?.last_name" required />
    ...
    <div class="grid gap-2">
      ...
      <Input id="email" name="email" type="email" :default-value="customer?.email" required />
    ...
    <div class="grid gap-2">
      ...
      <p class="text-xs text-foreground">
        Determines which VAT treatment is appropriate - you still pick the tax class by hand on each
        quote.
      </p>
