    ...
    >
      <div class="grid gap-2">
        ...
        <p id="intro-help" class="text-xs text-foreground">
          Shown above the line items. Leave it empty if a quote should open straight into the
          pricing.
        </p>
      ...
      <div class="grid gap-2">
        ...
        <p id="footer-help" class="text-xs text-foreground">
          This is where the reference to the algemene voorwaarden lives, so it cannot be left empty.
        </p>
        <InputError :message="errors.footer" />
      </div>

      <p class="max-w-prose text-sm text-foreground">
        Quotes keep a copy of both texts from the moment they were saved, so editing here never
        changes a quote that has already gone out. Save a quote as a new version to give it the
        current wording. Placeholders are filled in at that same moment, with the customer the quote
        is going to.
      </p>
