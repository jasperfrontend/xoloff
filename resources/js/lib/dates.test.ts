...
describe('formatDateTime', () => {
    ...
    it('reads day first, the way a date is read here', () => {
        ...
        expect(formatDateTime('2026-08-12T14:32:00+02:00')).toBe(
            '12-08-2026 14:32',
        );
    });

    it('uses the twenty-four hour clock', () => {
        expect(formatDateTime('2026-08-12T21:05:00+02:00')).toBe(
            '12-08-2026 21:05',
        );
    });

    it('pads a single digit day and month', () => {
        expect(formatDateTime('2026-01-05T09:07:00+01:00')).toBe(
            '05-01-2026 09:07',
        );
    });
